...
surface.CreateFont("WepSwitch", {font = "Octin Sports RG",
									size = 18,
									weight = 500})
...
function WSWITCH:DrawBarBg(x, y, w, h, col)
	...
	surface.DrawTexturedRectRotated(rx + bh, ry + bh, b, b, 180)
	surface.DrawTexturedRectRotated(rx + bh, ry + rh - bh, b, b, 270)
	...
	surface.DrawTexturedRectRotated(rx + rw - bh, ry + rh - bh, b, b, 0)
	surface.DrawTexturedRectRotated(rx + rw - bh, ry + bh, b, b, 90)
...
function WSWITCH:DrawWeapon(x, y, c, wep)
	...
	-- Slot
	local spec = { text = wep.Slot + 1, font = "WepSwitch", pos = { x, y }, yalign = TEXT_ALIGN_CENTER, color = c.text }
